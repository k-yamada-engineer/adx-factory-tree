...
P0:{title:"P0 受付・事業カルテ",cmd:"新規案件はまずここ（カルテなしに製造しない）",nodes:[
 ...
 {id:"P0-B3",t:"3C＋5Forces 実測リサーチ",ai:["ag"],det:{w:"競合・市場・自社の分析",o:"KW Volが実数（推定レンジは不合格）",tool:"PR Times / Yahoo知恵袋",skl:["desk-research","search-demand-mapping"],y:"生声と実数だけが証拠"}},
